    ...
    <div className="portfolio" id="portfolio">
      ...
      <div className="portfolio-grid">
        <div className="portfolio-item">
          ...
          >
            <img className="portfolio-image" src={picture4} alt="" />
          </a>
        ...
        <div className="portfolio-item">
          ...
          <a
            ...
            className="image-link"
          >
            <img className="portfolio-image" src={picture3} alt="" />
          </a>
          <div className="portfolio-text">
            ...
            solenoid valves control the oxygen supply when required.
            <br />
        ...
        <div className="portfolio-item">
          ...
          <a
            ...
            className="image-link"
          >
            <img className="portfolio-image" src={picture5} alt="" />
          </a>
          <div className="portfolio-text">
            ...
            a robust password generator, enabling you to create strong, unique passwords for each account.
            <br />
        ...
        <div className="portfolio-item">
          ...
          <a
            ...
            className="image-link"
          >
            <img className="portfolio-image" src={picture6} alt="" />
          </a>
          <div className="portfolio-text">
            This is a project where we wrote multiple API test cases for a project. It also includes multiple UI test cases written for https://practicesoftwaretesting.com/.
            <br />
        ...
        <div className="portfolio-item">
          ...
          <a
            ...
            className="image-link"
          >
            <img className="portfolio-image" src={picture7} alt="" />
          </a>
          <div className="portfolio-text">
        ...
        <div className="portfolio-item">
          ...
          <a
            ...
            className="image-link"
          >
            <img className="portfolio-image" src={picture8} alt="" />
          </a>
          <div className="portfolio-text">
